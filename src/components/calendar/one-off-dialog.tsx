 ...
 *
 * Given to people or left to a team, like the work already on the board: each
 * chosen person gets their own copy to complete, and with nobody chosen one
 * copy is shared by whoever works that team's day.
 */
